...
// BNB Smart Chain mainnet = 56 (0x38). Si el contrato estuviera en testnet, cambiar a 97 (0x61).
const TARGET_CHAIN_ID_HEX = '0x38';
const TARGET_CHAIN_ID_DEC = 56n;
...
async function renderTransactionHistory(){
  ...
  try{
    ...
    listEl.innerHTML = '<div class="activity-empty">No se pudo cargar tu historial ahora mismo.</div>';
  }
}
